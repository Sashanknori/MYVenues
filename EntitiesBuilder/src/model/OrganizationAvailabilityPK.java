...
/**
 * The primary key class for the ORGANIZATION_AVAILABILITY database table.
 * 
 */
@Embeddable
public class OrganizationAvailabilityPK implements Serializable {
	...
	public OrganizationAvailabilityPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof OrganizationAvailabilityPK)) {
			return false;
		}
		OrganizationAvailabilityPK castOther = (OrganizationAvailabilityPK)other;
		return 
